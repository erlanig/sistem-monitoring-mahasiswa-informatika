    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        ...
        @if ($pklExist)
            ...
            <div class="grid grid-cols-1 gap-2 mb-2">
                <form method="POST" action="{{ route('mahasiswa.createpkl', $pkl->id_mhs) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="flex items-center justify-center">
                      ...
                      <div class="flex items-center justify-center w-full mt-2">
                          <div>
                              <label for="small-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nilai PKL</label>
                              <input type="text" id="small-input" name="nilai_pkl" class="@error('tgl_pinjam') is-invalid @enderror block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{$pkl->nilai_pkl}}">
                          </div>
                      </div>
                      <div class="flex items-center justify-center mt-6">
                      <label for="small-input" class="block justify-center mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload Scan PKL</label>
                      </div>
                      <div class="flex items-center justify-center w-full mt-2">
                          <div class="flex items-center justify-center w-full">
                              <label for="dropzone-file" class="flex flex-col items-center justify-center w-96 h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                  ...
                                  <input id="dropzone-file" name="berkas_pkl" type="file" class="text-xs text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-400 dark:border-gray-600 dark:placeholder-gray-400"/>
                              </label>
                          </div>
                      </div>
        ...
        @else
            ...
            <div class="grid grid-cols-1 gap-2 mb-2">
                <form method="POST" action="{{ route('mahasiswa.createpkl', $mahasiswa->id_mhs) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="flex items-center justify-center">
                        @if($errors->any())
                          <div class="p-4 mt-3 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 w-1/2">
