...
<html>
<head>
    <title>Rekap Data PKL Informatika Undip</title>
...
<body>
    ...
    <div class="header">
        <h5 class="mt-4 font-bold">Rekap Data PKL Informatika Undip</h5>
    </div>
	<table class="mt-2" style="width: 60%;">
		<tr>
    ...
    <table class="mt-4">
        ...
        <tbody>
            ...
            <tr>
                <td class="p-2">{{ $i++ }}</td>
                <td class="p-2">{{$p->NIM}}</td>
                <td class="p-2">{{$p->nama}}</td>
                <td class="p-2">{{$p->angkatan}}</td>
                <td class="p-2">{{$p->status_pkl}}</td>
                <td class="p-2">{{$p->nilai_pkl}}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
