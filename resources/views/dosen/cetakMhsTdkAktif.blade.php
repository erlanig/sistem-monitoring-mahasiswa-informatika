...
<html>
<head>
    <title>Data Mahasiswa Tidak Aktif Informatika Undip</title>
...
<body>
    ...
    <div class="header">
        <h5 class="mt-16 font-bold">Data Mahasiswa Mahasiswa Tidak Aktif Informatika Undip Angkatan {{$tahun}}</h5>
    </div> 
    ...
    <table class="mt-4">
        ...
        <tbody>
            @php $i=1 @endphp
            @foreach($tdkAktif as $t)
            <tr>
                <td class="p-2">{{ $i++ }}</td>
                <td class="p-2">{{ $t->NIM }}</td>
                <td class="p-2">{{ $t->nama }}</td>
                <td class="p-2">{{ $t->angkatan }}</td>
