...
<div class="p-4 sm:ml-64">
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        <div class="grid grid-cols-1 gap-4 mb-4">
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white">Data Rekap PKL Mahasiswa</p>
            </div>
            <div>
                <a href="{{ route('departemen.cetakrekappkl') }}" class="text-white bg-blue-500 hover:bg-blue-600 font-medium text-base text-center py-2 px-4 rounded-full" target="_blank">Cetak Rekap</a>
                        ...
                        <tr class="text-center">
                            @foreach ($tahun as $year)
                                <td class="py-2 text-blue-500 font-medium text-base text-center">
                                    <a href="{{ route('departemen.sudahpkl', ['tahun' => $year]) }}">
                                        {{ $jumlahMahasiswaPKL[$year] }}
                                    </a>
                                </td>
                                <td class="py-2 text-blue-500 font-medium text-base text-center">                                    
                                    <a href="{{ route('departemen.belumpkl', ['tahun' => $year]) }}">
