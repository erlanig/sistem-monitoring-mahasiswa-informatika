     ...
     <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="pt-2 mb-3 font-medium">
          ...
          <div class="flex items-center">
              <img class="w-12 h-12 rounded-full" src="{{ asset('fotoProfil/'.$dept->foto) }}" alt="user photo">
              <div class="ml-2">
                  <a class="text-xs">{{ $dept->nama }}</a>
                  <p class="text-xs font-thin text-gray-500">{{ $dept->NIP }}</p>
              </div>
          </div>
           </li>
        </ul>
